...
if __name__ == '__main__':
    ...
    try:
        ...
        # Training
        if k_fold_caud:
            species_tp.k_fold_resnet(20, "caud", k_folds=5, batch=16, rotation=16, brightness=0.04160844, loss=0.0002188637)
        if k_fold_dors:
            species_tp.k_fold_resnet(20, "dors", k_folds=5, batch=64, rotation=4, brightness=0.2320837289, loss=0.00042698)
        if k_fold_fron:
            species_tp.k_fold_resnet(20, "fron", k_folds=5, batch=32, rotation=3, brightness=0.124352955, loss=0.0002323599)
        if k_fold_late:
            species_tp.k_fold_resnet(20, "late", k_folds=5, batch=32, rotation=16, brightness=0.05717608, loss=0.00036962807)
        ...
        # Training
        if k_fold_caud:
            genus_tp.k_fold_resnet(20, "caud", k_folds=5, batch=16, rotation=2, brightness=0.121347939, loss=0.000414240154)
        if k_fold_dors:
            genus_tp.k_fold_resnet(20, "dors", k_folds=5, batch=16, rotation=13, brightness=0.169855976, loss=0.000179720464)
        if k_fold_fron:
            genus_tp.k_fold_resnet(20, "fron", k_folds=5, batch=16, rotation=6, brightness=0.05464547869, loss=0.0002265474186)
        if k_fold_late:
            genus_tp.k_fold_resnet(20, "late", k_folds=5, batch=32, rotation=10, brightness=0.29610847517, loss=0.0001860446889)
